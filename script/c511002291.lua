...
function c511002291.initial_effect(c)
	...
	c:RegisterEffect(e3)
	if not c511002291.global_check then
		c511002291.global_check=true
		local ge2=Effect.CreateEffect(c)
		ge2:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_CONTINUOUS)
		ge2:SetCode(EVENT_ADJUST)
		ge2:SetCountLimit(1)
		ge2:SetProperty(EFFECT_FLAG_NO_TURN_RESET)
		ge2:SetOperation(c511002291.archchk)
		Duel.RegisterEffect(ge2,0)
	end
end
function c511002291.archchk(e,tp,eg,ep,ev,re,r,rp)
...
function c511002291.sumop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,aux.NecroValleyFilter(c511002291.filter),tp,LOCATION_GRAVE,0,1,1,nil,e,tp)
