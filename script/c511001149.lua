...
function c511001149.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetCondition(c511001149.discon)
	...
	e3:SetOperation(c511001149.reset)
	e3:SetReset(RESET_EVENT+0x1fe0000+RESET_PHASE+PHASE_STANDBY+RESET_SELF_TURN,5)
	c:RegisterEffect(e3)
end
function c511001149.reset(e,tp,eg,ep,ev,re,r,rp)
	c511001149.disop(e:GetLabelObject(),tp,eg,ep,ev,e,r,rp)
end
function c511001149.discon(e,tp,eg,ep,ev,re,r,rp)
