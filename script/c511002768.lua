...
function c511002768.filter1(c,e,tp)
	return c:IsCanBeSpecialSummoned(e,0,tp,false,false) and c:GetFlagEffect(511002768)~=0
...
function c511002768.filter2(c,e,tp,mc,rk)
	...
	return mc:IsType(TYPE_XYZ,c,SUMMON_TYPE_XYZ,tp) and c:GetRank()==rk and mc:IsCanBeXyzMaterial(c,tp) and c:IsSetCard(0xba) 
